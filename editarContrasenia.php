  ...
  <body>
    ...
    <div class="section row2">
      <div id="container" align="center">
        ...
        <br>
          <form id="regform" style="border: 0px;" method="POST" action="controladores/validadorEditarContrasenia.php" onsubmit="return(editarPass())" enctype="multipart/form-data"><!-- para subir imagen -->
